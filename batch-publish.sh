...
emacsclient -s $EMACS_SERVER_NAME -c --eval "(progn (eab/update-reports-nightly) (org-publish-project \"html\" t) (eab/send-csum) (eab/send-csum-all) (org-mobile-push) (eab/update-agenda) (delete-frame nil 'force))"
