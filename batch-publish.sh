...
emacsclient -s $EMACS_SERVER_NAME -c --eval "(progn (eab/update-reports-nightly) (org-publish-project \"html\" t) (org-publish-project \"pdf\" t) (eab/send-csum) (org-agenda-redo) (delete-frame nil 'force))"
